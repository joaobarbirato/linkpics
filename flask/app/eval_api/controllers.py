...
from app import app
from app.align_api.models import MWE, Synonym
...
from app.eval_api.models import PredAlignment, EvalModel, Batch, get_all_batch
from app.login_api.models import User

# Define the blueprint: 'auth', set its url prefix: app.url/auth
from app.model_utils import query_by_id
