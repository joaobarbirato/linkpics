...
from back_app.src.UTIL.general import *
from back_app.src.UTIL.domain import *
    ...
    def coletar_img(self, url, nome_arquivo):
        ...
        for p in dados_dentro_paragrafo:
            ...
            for img in imgs:
                ...
                name = nome_arquivo + ".jpg"
                urllib.request.urlretrieve(img_url, name)
                write_file(nome_arquivo + "_imgurl.txt", " ")
                append_to_file(nome_arquivo + "_imgurl.txt", img_url)
