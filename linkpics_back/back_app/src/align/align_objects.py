...
from back_app.align_api.models import Alignment
from back_app.src.PLN.WordNetClasses import TrazerSynsetBoundingBox
from back_app.src.PLN.trocar_nomes import TrocarNomes
    ...
    def _experiment_1(self):
        ...
        for palavra, value in dic_alinhamento.items():
            ...
            cv2.rectangle(img_original, (x, y), (x + w, y + h), self.palette.next_color(type="bb", inc=True),
                          2)
            self.index_cor_bounding_box += 1
            dic_json[palavra] = {'x': x, 'y': y, 'w': w, 'h': h}
            bbox_objects.pop(0)
